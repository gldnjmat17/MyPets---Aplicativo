...
internal class Maskara(private val mask: MaskSL) {
 ...
 */
private fun MaskSL.nextSelection(before: CharSequence, after: CharSequence, action: Action): Int {
 ...
 */
private fun MaskSL.isDone(after: CharSequence): Boolean {
